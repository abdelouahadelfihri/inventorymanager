...
class Constants {
    companion object {
        ...
        const val DELIVERY_LINE_TABLE = "delivery_line"
        ...
        const val PURCHASE_RECEIPT_LINE_TABLE = "purchase_receipt_line"
        ...
        const val DELIVERY_DETAIL_TABLE = "delivery_detail"
        const val ORDER_DETAIL_TABLE = "order_detail"
        const val UNIT_TABLE = "unit"
        const val ITEM_TABLE = "item"
        const val SALE_RECEIPT_TABLE = "sale_receipt"
        const val SALE_RECEIPT_DETAIL_TABLE = "sale_receipt_detail"
        const val PURCHASE_RECEIPT_TABLE = "purchase_receipt"
        const val PURCHASE_RECEIPT_DETAIL_TABLE = "purchase_receipt_detail"
        ...
        const val UPDATE_CATEGORY = "Update a category."
